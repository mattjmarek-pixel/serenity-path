...
export const Colors = {
  light: {
    ...
    tabIconSelected: "#7B3FF2",
    link: "#7B3FF2",
    backgroundRoot: "#F8F7FC",
    backgroundDefault: "#FFFFFF",
    backgroundSecondary: "#F0EFF5",
    backgroundTertiary: "#E5E4EB",
    primary: "#7B3FF2",
    secondary: "#3A9BD9",
    accent: "#06D6A0",
    emergency: "#C62828",
  ...
  dark: {
    ...
    buttonText: "#FFFFFF",
    tabIconDefault: "#7A7A95",
    tabIconSelected: "#B794F6",
    link: "#B794F6",
    backgroundRoot: "#0D0D18",
    backgroundDefault: "#16162A",
    backgroundSecondary: "#222240",
    backgroundTertiary: "#2E2E55",
    primary: "#B794F6",
    secondary: "#64D2FF",
    accent: "#5EEAD4",
    emergency: "#FF6B6B",
